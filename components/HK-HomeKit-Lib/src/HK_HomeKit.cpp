...
HK_HomeKit::HK_HomeKit(readerData_t& readerData, bool (*update_reader_data_func)(), std::vector<uint8_t>& tlvData) : tlvData(tlvData), readerData(readerData) {
